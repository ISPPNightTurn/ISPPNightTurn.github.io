            ...
            <Media query="(max-width: 768px)">
                {matches => 
                    matches ? (
                        <div style={style}>
                        <div style={substyle}>
                            <img style={{maxWidth: '60%', height: 'auto'}} src='https://i.imgur.com/PMKDt3n.png' alt='Eventos disponibles' />
                        ...
                        <div style={substyleDesktop}>
                            <img style={{maxWidth: '30%', height: 'auto'}} src='https://i.imgur.com/PMKDt3n.png' alt='Eventos disponibles' />
                            <h4>Revisa los eventos disponibles a tu alrededor</h4>
                        </div>
                        <div style={substyleDesktop}>
